...
window.addEventListener("scroll", () => {
  ...
  //authname.style.transform = `translateX(calc(100vh - ${offsetY * 0.1}px))`;
  authname.style.transform = `translateX(calc(-100vh + ${offsetY}px))`;
  ...
  laptops[0].style.transform = `translateX(calc(600vh - ${offsetY}px))`;
  phones[1].style.transform = `translateX(calc(750vh - ${offsetY}px))`;
  laptops[1].style.transform = `translateX(calc(900vh - ${offsetY}px))`;
});
